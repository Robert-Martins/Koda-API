...
public class JobStatusController {
    ...
    @GetMapping("/{statusId}")
    public ResponseEntity<com.robertmartins.notesapi.models.JobStatus> getJobStatus(Authentication authentication, @PathVariable(name = "id")int id, @PathVariable(name = "statusId") int statusId){
