...
public class WorkspaceService implements WorkspaceResource {
    ...
    public com.robertmartins.notesapi.models.Workspace save(NewWorkspaceDto workspaceDto, int id){
        var user = userResource.findById(id);
        var workspace = this.setWorkspace(workspaceDto);
        List<com.robertmartins.notesapi.models.Workspace> workspaceModelList = user.getWorkspaces();
    ...
    @Transactional
    public com.robertmartins.notesapi.models.Workspace update(NewWorkspaceDto workspaceDto, int workspaceId){
    ...
    public com.robertmartins.notesapi.models.Workspace findById(int id) throws ResourceNotFoundException{
    ...
    @Transactional
    private void deleteStatusById(List<com.robertmartins.notesapi.models.Job> jobsList, int id){
        var jobStatus = jobStatusResource.findById(id);
    ...
    public com.robertmartins.notesapi.models.Workspace setWorkspace(NewWorkspaceDto newWorkspaceDto){
        var workspace = new com.robertmartins.notesapi.models.Workspace();
